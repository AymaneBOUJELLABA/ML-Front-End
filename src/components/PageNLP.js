...
class PageNLP extends React.Component
{
    ...
    {   
        ...
        const style = this.state.method!=="bag_of_words"? {visibility:"hidden"}:{visibility:"visible"};
        return (
            <>
                    ...
                    <Row>
                        <Col span={8}>
                            <Form.Item name="method"
                                    rules={[{required: true}]}>
                                <Select placeholder="Select a NLP Method" style={{color:"#2BB55C", fontWeight:"bold"}}
                                            onChange={this.onMethodChange} bordered={true} allowClear>
                        ...
                        <Col span={6} style={style}>
                            <Text type="secondary">Please Seperate phrases with <Text code>;</Text></Text>
                        </Col>
                        <Col span={6} push={4}>
                            <Form.Item>
                ...
                {this.state.result&&
                <Row style={{textAlign:'left', maxHeight:300, overflow:"scroll"}}>
                    <Col span={24}>
                        <JSONView name={false} collapseStringsAfterLength="10" theme="monokai" displayDataTypes={false} src={this.state.result}></JSONView> 
                    </Col>
                </Row>}
            </>            
        );
